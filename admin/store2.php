...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['snoEdit'])) {
        ...
        $sql = "UPDATE storetwo SET bookid='$bookid',bookname = '$bookname',inventory = '$count'  WHERE id= $sno";
...
<body>
    ...
    <div class="container searchContainer">
        ...
        <button class="btn btn-primary"><a class="text-light" href="admin.php">Go Back</a></button>
    </div>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        echo   '<div class="col-sm-8 form-group">
                         <form action="addstore2.php" method="POST">
                                <div class="row">
    ...
    <div class="container">
        <table class="table">
            ...
            <tbody>
                <?php
                $sqlForView = "SELECT * FROM storetwo";
     ...
     <button class="btn btn-danger"><a class="text-light" href="delete2.php?deleteBookId=' . $row["id"] . '">Delete</a></button></td>
   </tr>';
                    $no = $no + 1;
                }
