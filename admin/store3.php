...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['snoEdit'])) {
        ...
        $sql = "UPDATE storethree SET bookid='$bookid',bookname = '$bookname',inventory = '$count'  WHERE id= $sno";
...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        echo   '<div class="col-sm-8 form-group">
                         <form action="addstore3.php" method="POST">
                                <div class="row">
    ...
    <div class="container">
     ...
     <button class="btn btn-danger"><a class="text-light" href="delete3.php?deleteBookId=' . $row["id"] . '">Delete</a></button></td>
   </tr>';
                    $no = $no + 1;
                }
