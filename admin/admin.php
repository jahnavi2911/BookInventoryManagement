...
<body>
  ...
  <div class="container">
    ...
    <p class="text-center">You can search new books,add them to the database and update them in each store. </p>
  </div>
  <div class="container">
    <div class="row">
      <div class="col-sm-6">
        <div class="card">
          <div class="card-body">
            ...
            <a href="store1.php" class="btn btn-primary">Check here</a>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="card">
          <div class="card-body">
            ...
            <a href="store2.php" class="btn btn-primary">Check here</a>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="card">
          <div class="card-body">
            ...
            <a href="store3.php" class="btn btn-primary">Check here</a>
          </div>
        </div>
      </div>
    </div>
